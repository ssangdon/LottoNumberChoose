...
function capitalize(string) {
  if (typeof string !== 'string') {
    throw new Error( false ? 0 : (0,utils_.formatMuiErrorMessage)(7));
  }
...
var Button = /*#__PURE__*/external_react_.forwardRef(function Button(props, ref) {
  ...
  var startIcon = startIconProp && /*#__PURE__*/external_react_.createElement("span", {
    className: external_clsx_default()(classes.startIcon, classes["iconSize".concat(capitalize(size))])
  }, startIconProp);
  var endIcon = endIconProp && /*#__PURE__*/external_react_.createElement("span", {
    className: external_clsx_default()(classes.endIcon, classes["iconSize".concat(capitalize(size))])
  }, endIconProp);
